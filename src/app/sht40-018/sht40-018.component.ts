...
@Component({
    ...
    templateUrl: './sht40-018.component.html',
    styleUrls: ['./sht40-018.component.scss'],
})
export class SHT40_018_Component implements OnInit, OnDestroy {
    ...
    wrNodeData_0() {
        ...
        data.setUint32(idx, this.globals.SHT40_018, this.globals.LE);
        idx += 4;
