...
@Component({
    selector: 'app-rkr-sw-012',
    templateUrl: './rkr-sw-012.html',
    styleUrls: ['./rkr-sw-012.scss'],
})
export class RKR_SW_012_Component implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.events.subscribe('rdNodeDataRsp', (msg)=>{
            ...
            if(partNum == this.globals.RKR_SW_012) {
                this.ngZone.run(()=>{
    ...
    wrNodeData_0() {
        ...
        data.setUint32(idx, this.globals.RKR_SW_012, this.globals.LE);
        idx += 4;
