...
@Component({
    selector: 'app-pb-sw-023',
    templateUrl: './pb-sw-023.html',
    styleUrls: ['./pb-sw-023.scss'],
})
export class PB_SW_023_Component implements OnInit, OnDestroy {
    ...
    wrNodeData_0() {
        ...
        data.setUint32(idx, this.globals.PB_SW_023, this.globals.LE);
        idx += 4;
