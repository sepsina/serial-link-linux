...
@Component({
    selector: 'app-tgl-sw-011',
    templateUrl: './tgl-sw-011.html',
    styleUrls: ['./tgl-sw-011.scss'],
})
export class TGL_SW_011_Component implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.events.subscribe('rdNodeDataRsp', (msg)=>{
            ...
            if(partNum == this.globals.TGL_SW_011) {
                this.ngZone.run(()=>{
    ...
    wrNodeData_0() {
        ...
        data.setUint32(idx, this.globals.TGL_SW_011, this.globals.LE);
        idx += 4;
